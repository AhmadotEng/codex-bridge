...
def main(argv=None):
    ...
    select.add_argument('--policy',choices=['read-only','workspace-write','full-access'],help='Owner-selected execution policy; full-access uses this account beyond the workspace, including network access'); select.add_argument('--operations'); select.add_argument('--peer-project-id')
